...
export function PricingFaq() {
  ...
  const faqCategories = [
      ...
      questions: [
        {
          ...
          answer: "እንቆቅCash is a comprehensive platform that allows users to create, share, and take quizzes on various topics. It's designed for educators, content creators, businesses, and quiz enthusiasts who want to create engaging learning experiences.",
        },
        {
          question: "How do I get started with እንቆቅCash ?",
        ...
        {
          question: "Can I try እንቆቅCash  before purchasing?",
      ...
      questions: [
        {
          ...
          answer: "እንቆቅCash supports multiple quiz formats including multiple choice, true/false, fill-in-the-blank, matching, ranking, and open-ended questions. You can also add images, videos, and audio to your quizzes.",
        },
        {
    ...
    },
    {
      ...
      questions: [
        {
          question: "How secure is my data on እንቆቅCash ?",
      ...
      <div className="container px-4 mx-auto">
        ...
        <div className="mt-12 text-center">
          <p className="text-slate-600 dark:text-slate-400">
            ...
            <a href="mailto:support@እንቆቅCash.com" className="text-purple-600 hover:text-purple-700 font-medium">
              support@እንቆቅCash.com
            </a>
          </p>
        </div>
      </div>
