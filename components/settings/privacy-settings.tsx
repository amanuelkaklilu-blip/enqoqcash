  ...
  return (
    <div className="space-y-6">
      <div>
        ...
        <p className="text-sm text-muted-foreground">Control your privacy and how your information is shared on እንቆቅCash .</p>
      </div>
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>Control how your data is used on እንቆቅCash .</CardDescription>
        </CardHeader>
        <CardContent className="space-y-4">
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-4">
              ...
              <div>
                ...
                <p className="text-sm text-muted-foreground">Allow እንቆቅCash to collect data to improve your experience.</p>
              </div>
            </div>
