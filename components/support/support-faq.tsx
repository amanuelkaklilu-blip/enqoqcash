...
export function SupportFAQ({ selectedCategory }: SupportFAQProps) {
  ...
  const allFaqs = {
    ...
    general: [
      {
        question: "What is እንቆቅCash ?",
        answer: "እንቆቅCash is an interactive platform where users can create, share, and take quizzes on various topics. It combines educational content with gamification elements, allowing creators to earn from their quizzes while players can win prizes and climb leaderboards.",
      },
      {
      ...
      {
        question: "Is እንቆቅCash  available on mobile devices?",
        answer: "Yes, እንቆቅCash  is fully responsive and works on all mobile browsers. We also offer dedicated apps for iOS and Android with additional features like offline quiz taking and push notifications for tournament reminders.",
      },
      {
        question: "Can I use እንቆቅCash  for educational purposes?",
        answer: "Many educators use እንቆቅCash  to create engaging learning materials. We offer special educational accounts with features like student progress tracking, classroom management, and the ability to align quizzes with curriculum standards.",
      },
      {
        question: "How do I contact customer support?",
        answer: "You can contact our support team through the 'Contact Us' tab on this page, by emailing support@እንቆቅCash.com, or by using the chat button in the bottom right corner of any page. Our support team is available 24/7 to assist with any questions or issues.",
      },
    ],
  };
