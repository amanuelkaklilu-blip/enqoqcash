    ...
    <section className="py-20 bg-gradient-to-r from-purple-600 to-indigo-600 text-white">
      <div className="container px-4 mx-auto">
        <div className="max-w-3xl mx-auto text-center">
          ...
          <p className="text-lg text-purple-100 mb-8 max-w-2xl mx-auto">Join thousands of successful affiliates who are earning passive income by sharing እንቆቅCash with their audience. It only takes 2 minutes to get started.</p>
          ...
          <p className="mt-8 text-sm text-purple-200">
            ...
            <a href="mailto:affiliates@እንቆቅCash.com" className="underline hover:text-white">
              affiliates@እንቆቅCash.com
            </a>
          </p>
        </div>
      </div>
