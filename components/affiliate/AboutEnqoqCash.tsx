      ...
      <div className="container px-4 mx-auto">
        <div className="text-center mb-12">
          <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} transition={{ duration: 0.5 }} viewport={{ once: true }}>
            <h2 className="text-3xl md:text-4xl font-bold mb-4">About እንቆቅCash </h2>
        ...
        <div className="grid md:grid-cols-2 gap-12 lg:gap-20 items-center">
          ...
          <motion.div initial={{ opacity: 0, x: 20 }} whileInView={{ opacity: 1, x: 0 }} transition={{ duration: 0.5, delay: 0.2 }} viewport={{ once: true }} className="space-y-8">
            <div>
              ...
              <p className="text-slate-600 dark:text-slate-400 mb-4">Founded in 2018, እንቆቅCash began with a simple mission: to transform learning into an engaging, interactive experience. What started as a small project has grown into a global platform used by educators, businesses, and quiz enthusiasts in over 150 countries.</p>
