...
export function WhyPartner() {
  ...
  const testimonials = [
    {
      quote: "I've been part of many affiliate programs, but እንቆቅCash 's stands out with its high commission rates and reliable tracking. I've earned over $5,000 monthly since joining.",
      ...
      <div className="container px-4 mx-auto">
        <div className="text-center mb-16">
          <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} transition={{ duration: 0.5 }} viewport={{ once: true }}>
            ...
            <p className="text-lg text-slate-600 dark:text-slate-400 max-w-3xl mx-auto">Join thousands of successful affiliates who are earning substantial income by promoting እንቆቅCash </p>
          </motion.div>
        </div>
              ...
              <table className="w-full">
                <thead>
                  <tr className="bg-slate-50 dark:bg-slate-800">
                    ...
                    <th className="text-center p-4 font-medium">እንቆቅCash Affiliate</th>
