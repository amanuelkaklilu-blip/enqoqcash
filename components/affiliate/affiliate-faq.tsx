  ...
  const faqs = [
    {
      ...
      answer: "Our affiliate program is simple: you refer users to እንቆቅCash  using your unique link, and you earn a 30% commission on all their subscription payments for as long as they remain a customer. We track all referrals automatically and pay out monthly.",
    },
    {
    ...
    },
    {
      ...
      answer: "Social media is one of the best ways to promote እንቆቅCash . You can share your affiliate link on platforms like Twitter, Facebook, Instagram, TikTok, and LinkedIn. We even provide platform-specific content templates in your dashboard.",
    },
    {
