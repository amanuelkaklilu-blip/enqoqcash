    ...
    <section className="py-10 md:py-16 bg-white dark:bg-slate-900">
      <div className="container px-4 mx-auto">
        <div className="max-w-3xl mx-auto text-center mb-12">
          ...
          <p className="text-slate-600 dark:text-slate-400 max-w-2xl mx-auto">Getting started with our affiliate program is simple. Follow these steps and start earning passive income by sharing እንቆቅCash with your audience.</p>
        </div>
