    ...
    <section className="py-10 xl:py-20 sm:px-4 xl:px-8 bg-slate-50 dark:bg-slate-900">
      <div className="container px-4 mx-auto">
        <div className="max-w-3xl mx-auto text-center mb-16">
          ...
          <p className="text-lg text-slate-600 dark:text-slate-400 max-w-2xl mx-auto">Use our calculator to estimate how much you could earn as a እንቆቅCash affiliate. Adjust the sliders to match your audience and see your potential earnings.</p>
        </div>
        ...
        <div className="grid md:grid-cols-2 gap-8 lg:gap-12 items-center">
          ...
          <motion.div initial={{ opacity: 0, x: -20 }} whileInView={{ opacity: 1, x: 0 }} transition={{ duration: 0.5 }} viewport={{ once: true }} className="space-y-8">
            <div className="space-y-4">
              ...
              <p className="text-sm text-slate-500 dark:text-slate-400">The number of people you refer to እንቆቅCash each month</p>
            </div>
            ...
            <div className="space-y-4">
              ...
              <p className="text-sm text-slate-500 dark:text-slate-400">The average amount your referrals spend on እንቆቅCash </p>
            </div>
          </motion.div>
