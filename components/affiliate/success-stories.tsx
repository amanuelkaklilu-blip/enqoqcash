  ...
  const stories = [
    {
      ...
      quote: "I've been promoting እንቆቅCash  to my audience for 6 months now and the results have been incredible. The 30% commission is one of the best in the industry, and the recurring revenue has added a reliable income stream to my business.",
    ...
    },
    {
      ...
      quote: "What I love about እንቆቅCash 's affiliate program is how easy they make it to promote. The marketing materials are top-notch, and my audience loves the product. I'm earning more with እንቆቅCash  than with any other affiliate program I've tried.",
    ...
    },
    {
      ...
      quote: "As someone who creates educational content, እንቆቅCash  was a natural fit for my audience. The affiliate dashboard makes it easy to track my performance, and the team is always responsive when I have questions. Highly recommended!",
    ...
    <section className="py-10 xl:py-16 bg-white dark:bg-slate-900">
      <div className="container px-4 mx-auto">
        <div className="max-w-3xl mx-auto text-center mb-12">
          ...
          <p className="text-slate-600 dark:text-slate-400">Hear from our top-performing affiliates who are earning consistent income by promoting እንቆቅCash .</p>
        </div>
