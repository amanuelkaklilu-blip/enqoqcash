...
export const articlesData: KnowledgeBaseArticle[] = [
  {
    id: "getting-started",
    title: "Getting Started with እንቆቅCash",
    description: "Everything you need to know to begin your journey on our platform.",
    readTime: 5,
    category: "general",
    content: [
      {
        heading: "Welcome to እንቆቅCash",
        paragraphs: [
          "Welcome to እንቆቅCash , the premier platform for creating, sharing, and participating in quizzes across a wide range of topics. Whether you're an educator looking to engage your students, a content creator wanting to connect with your audience, or simply a quiz enthusiast, our platform offers all the tools you need to succeed.",
          "This guide will walk you through the basics of getting started with እንቆቅCash , from setting up your account to creating your first quiz and exploring the community.",
        ],
      },
      {
        heading: "Creating Your Account",
        paragraphs: ["To get started with እንቆቅCash , you'll need to create an account. Visit our homepage and click on the 'Sign Up' button in the top right corner. You can register using your email address, or sign up with your Google, Facebook, or Apple account for a quicker process."],
      ...
      },
      {
        ...
        paragraphs: ["Once you've created your account, you'll be taken to your dashboard. This is your personal hub where you can see your recent activity, track your progress, and access all the features of እንቆቅCash ."],
    ...
    content: [
      {
        ...
        paragraphs: ["A complete account setup ensures you get the most out of እንቆቅCash . This guide will walk you through all the steps to fully configure your account, from basic profile information to advanced settings and preferences.", "Taking the time to properly set up your account will enhance your experience and help you connect with like-minded quiz enthusiasts."],
      },
      {
        heading: "Profile Information",
        paragraphs: ["Your profile is your identity on እንቆቅCash . A complete profile helps others recognize you and builds trust in the community."],
      ...
      },
      {
        ...
        paragraphs: ["Connect your social media accounts to enhance your እንቆቅCash  experience. This allows for easier sharing of content and finding friends who are already on the platform."],
    ...
    content: [
      {
        ...
        paragraphs: ["እንቆቅCash offers several subscription tiers to meet different needs and budgets. Whether you're a casual quiz taker, a dedicated creator, or an educational institution, we have plans designed for you.", "This guide will help you understand how to manage your subscription, make changes to your plan, and handle billing issues."],
      },
      {
        heading: "Viewing Your Current Plan",
        paragraphs: ["To view your current subscription details, follow these steps:"],
        list: ["Log in to your እንቆቅCash  account", "Click on your profile picture in the top right corner", "Select 'Settings' from the dropdown menu", "Navigate to the 'Subscription & Billing' tab", "Here you'll see your current plan, billing cycle, and next payment date"],
      },
      {
    ...
    content: [
      {
        ...
        paragraphs: ["Creating engaging quizzes is both an art and a science. Whether you're an educator looking to test knowledge, a content creator wanting to engage your audience, or someone who loves sharing interesting challenges, this guide will walk you through the process of creating effective quizzes on እንቆቅCash .", "We'll cover everything from planning your quiz to publishing and sharing it with the world."],
      },
      {
      ...
      },
      {
        ...
        list: ["Log in to your እንቆቅCash  account", "Click the 'Create' button in the top navigation", "Select 'New Quiz' from the dropdown menu", "Enter a title, description, and category for your quiz", "Upload a cover image that represents your quiz topic", "Choose your quiz settings (time limit, randomization, etc.)", "Click 'Continue to Questions' to start building your quiz content"],
      },
      {
    ...
    content: [
      {
        ...
        paragraphs: ["Quiz tournaments take the excitement of quizzing to the next level by adding competition, time pressure, and prizes. Whether you're organizing an event for your classroom, workplace, or community, tournaments can dramatically increase engagement and participation.", "This guide will walk you through the process of creating and managing your first tournament on እንቆቅCash ."],
      },
      {
      ...
      },
      {
        ...
        list: ["Create new quizzes specifically for the tournament", "Select from your existing quizzes", "Import quizzes from the እንቆቅCash  library (premium feature)", "Invite other creators to contribute quizzes (collaboration feature)", "Use AI-generated quizzes based on your specifications"],
  ...
  },
  {
    ...
    content: [
      {
        heading: "Introduction to Privacy on እንቆቅCash",
        paragraphs: [
          "At እንቆቅCash , we understand the importance of privacy and giving you control over your personal information and content. This guide explains all the privacy settings available on our platform and how to configure them to match your preferences.",
      ...
      },
      {
        ...
        list: ["Log in to your እንቆቅCash  account", "Click on your profile picture in the top right corner", "Select 'Settings' from the dropdown menu", "Navigate to the 'Privacy' tab", "Here you'll find all privacy-related settings organized by category"],
      },
      {
      ...
      },
      {
        ...
        paragraphs: ["To maintain optimal privacy on እንቆቅCash , we recommend:", "Regularly review your privacy settings, especially after platform updates. Be mindful of what personal information you include in your profile, quizzes, and comments. Use strong, unique passwords and enable two-factor authentication for maximum security."],
  ...
  },
  {
    ...
    content: [
      ...
      },
      {
        ...
        paragraphs: ["The following types of content are strictly prohibited on እንቆቅCash :"],
